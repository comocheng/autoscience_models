...
entry(
    index = 319,
    label = "PC4H9(182) + SC4H9(183) <=> C4H8(188) + butane(1)",
    degeneracy = 1.0,
    elementary_high_p = True,
    kinetics = Arrhenius(A=(0.284033,'cm^3/(mol*s)'), n=3.31802, Ea=(55.6191,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 1.09164, dn = +|- 0.0115193, dEa = +|- 0.0626875 kJ/mol"""),
)
...
entry(
    index = 371,
    label = "CH3CHO(35) + PC4H9(182) <=> CH2CHO(21) + butane(1)",
    degeneracy = 1.0,
    elementary_high_p = True,
    kinetics = Arrhenius(A=(0.59166,'cm^3/(mol*s)'), n=3.28705, Ea=(31.1267,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 1.10998, dn = +|- 0.013709, dEa = +|- 0.0746041 kJ/mol"""),
)
...
entry(
    index = 417,
    label = "OH(15) + SC4H9(183) <=> H2O(8) + C4H8(189)",
    degeneracy = 1.0,
    elementary_high_p = True,
    kinetics = Arrhenius(A=(3770.96,'cm^3/(mol*s)'), n=2.73474, Ea=(-0.899118,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 1.08253, dn = +|- 0.0104183, dEa = +|- 0.056696 kJ/mol"""),
)
...
entry(
    index = 805,
    label = "PC4H9(182) + S(787) <=> S(229) + butane(1)",
    degeneracy = 1.0,
    elementary_high_p = True,
    kinetics = Arrhenius(A=(0.238661,'cm^3/(mol*s)'), n=3.15209, Ea=(0.0407152,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 1.19198, dn = +|- 0.0230729, dEa = +|- 0.125562 kJ/mol"""),
)
...
entry(
    index = 812,
    label = "HO2(16) + S(229) <=> O2(2) + S(787)",
    degeneracy = 1.0,
    elementary_high_p = True,
    kinetics = Arrhenius(A=(0.076864,'cm^3/(mol*s)'), n=3.21907, Ea=(-48.9833,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 1.12887, dn = +|- 0.015925, dEa = +|- 0.0866635 kJ/mol"""),
)

entry(
    index = 813,
    label = "HO2(16) + S(225) <=> O2(2) + S(787)",
    degeneracy = 1.0,
    elementary_high_p = True,
    kinetics = Arrhenius(A=(0.234903,'cm^3/(mol*s)'), n=3.25898, Ea=(-37.6701,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 1.11419, dn = +|- 0.0142056, dEa = +|- 0.0773064 kJ/mol"""),
)
...
entry(
    index = 1706,
    label = "HO2(16) + S(186) <=> O2(2) + S(187)",
    degeneracy = 1.0,
    elementary_high_p = True,
    kinetics = Arrhenius(A=(2.68344,'cm^3/(mol*s)'), n=3.36483, Ea=(-13.0722,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 1.09426, dn = +|- 0.0118341, dEa = +|- 0.0644005 kJ/mol"""),
)
